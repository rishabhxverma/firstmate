...
FM_INHERITABLE_CONFIG="${FM_INHERITABLE_CONFIG:-auto-resume crew-dispatch.json crew-harness backlog-backend backend herdr-presentation-spaces startup-memory-budget trace-context}"
